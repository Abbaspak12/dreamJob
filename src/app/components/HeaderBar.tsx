...
<h1 className='font-semibold text-[18px] text-[#FFFFFF] cursor-pointer'>Product</h1>
<BiDotsHorizontalRounded className=' text-[#FFFFFF]' size={30}/>
<h1 className='font-semibold text-[18px] text-[#FFFFFF] cursor-pointer'>Performance</h1>
<BiDotsHorizontalRounded className=' text-[#FFFFFF]' size={30}/>
<h1 className='font-semibold text-[18px] text-[#FFFFFF] cursor-pointer'>Dashboard</h1>
</div>
